...
//                String colName = attributes[i].split("\"")[1];
        ...
        List<String> sqlStatements = List.of(
                "SELECT name FROM people WHERE name=\"Ou\" OR age<31",
                "SELECT name FROM people WHERE name=\"Bob\"",
                "SELECT name FROM people WHERE (name=\"Bob\" AND age>21) OR (age<21 OR age>41)",
                "SELECT name FROM people WHERE name!=\"Bob\" AND age>50"
                );
