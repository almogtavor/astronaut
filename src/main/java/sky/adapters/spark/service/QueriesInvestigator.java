...
public class QueriesInvestigator {
    ...
    public void investigateQueryExecution(QueryInvestigation queryInvestigation, Expression expression) {
        switch (expression) {
            ...
            case Not not -> handleExpression(queryInvestigation, not); //TODO
            ...
            case IsNull isNull -> handleExpression(queryInvestigation, isNull); //TODO
            case IsNotNull isNotNull -> handleExpression(queryInvestigation, isNotNull); //TODO
                ...
                switch (queryInvestigation.debugMode()) {
                    case ON_FAILURE -> {
                        if (isQuerySucceeded(queryInvestigation.rowDataframe(), expressionHandler.getStatement())) {
                            log.info("The reason for failure wasn't: " + binaryOperator.sql());
                        } else {
    ...
    private void handleExpression(QueryInvestigation queryInvestigation, Expression expression) {
        ...
        switch (queryInvestigation.debugMode()) {
            case ON_FAILURE -> {
                if (isQuerySucceeded(queryInvestigation.rowDataframe(), expressionHandler.getStatement())) {
                    System.out.println("The reason for failure wasn't: " + expression.sql());
                } else {
            ...
            case NEVER -> {}
            case default -> System.out.println("unexpected debug mode: " + queryInvestigation.debugMode());
        }
    }
